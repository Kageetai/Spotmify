...
export const LOAD_TRACK = 'spotmify/App/LOAD_TRACK';
export const LOAD_TRACK_SUCCESS = 'spotmify/App/LOAD_TRACK_SUCCESS';
export const LOAD_TRACK_ERROR = 'spotmify/App/LOAD_TRACK_ERROR';
