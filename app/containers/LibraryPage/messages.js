...
export default defineMessages({
  ...
  scaffoldingHeader: {
    id: 'boilerplate.containers.LibraryPage.scaffolding.header',
    defaultMessage: 'Quick scaffolding',
  },
  scaffoldingMessage: {
    id: 'boilerplate.containers.LibraryPage.scaffolding.message',
    defaultMessage: `Automate the creation of components, containers, routes, selectors
  and sagas - and their tests - right from the CLI!`,
  },
  feedbackHeader: {
    id: 'boilerplate.containers.LibraryPage.feedback.header',
    defaultMessage: 'Instant feedback',
  },
  feedbackMessage: {
    id: 'boilerplate.containers.LibraryPage.feedback.message',
    defaultMessage: `
  ...
  stateManagementHeader: {
    id: 'boilerplate.containers.LibraryPage.state_management.header',
    defaultMessage: 'Predictable state management',
  },
  stateManagementMessages: {
    id: 'boilerplate.containers.LibraryPage.state_management.message',
    defaultMessage: `
  ...
  javascriptHeader: {
    id: 'boilerplate.containers.LibraryPage.javascript.header',
    defaultMessage: 'Next generation JavaScript',
  },
  javascriptMessage: {
    id: 'boilerplate.containers.LibraryPage.javascript.message',
    defaultMessage: `Use template strings, object destructuring, arrow functions, JSX
    syntax and more, today.`,
  },
  cssHeader: {
    id: 'boilerplate.containers.LibraryPage.css.header',
    defaultMessage: 'Features',
  },
  cssMessage: {
    id: 'boilerplate.containers.LibraryPage.css.message',
    defaultMessage: 'Next generation CSS',
  },
  routingHeader: {
    id: 'boilerplate.containers.LibraryPage.routing.header',
    defaultMessage: 'Industry-standard routing',
  },
  routingMessage: {
    id: 'boilerplate.containers.LibraryPage.routing.message',
    defaultMessage: `
  ...
  networkHeader: {
    id: 'boilerplate.containers.LibraryPage.network.header',
    defaultMessage: 'Offline-first',
  },
  networkMessage: {
    id: 'boilerplate.containers.LibraryPage.network.message',
    defaultMessage: `
  ...
  intlHeader: {
    id: 'boilerplate.containers.LibraryPage.internationalization.header',
    defaultMessage: 'Complete i18n Standard Internationalization & Pluralization',
  },
  intlMessage: {
    id: 'boilerplate.containers.LibraryPage.internationalization.message',
